...
class PelanggaranController extends Controller
{
    ...
    public function print(Request $request)
    {
        ...
        $conector = new WindowsPrintConnector("EPSON TM-T82 Receipt");
        ...
        $printer->feed();
        $printer->setJustification(Printer::JUSTIFY_LEFT);
        $printer->text("Janganlah kamu melakukan pelanggaran, karena kalian sekolah untuk mencari ilmu sebanyak banyaknya bukan untuk mencari pelanggaran sebanyak mungkin");
        $printer->feed();
