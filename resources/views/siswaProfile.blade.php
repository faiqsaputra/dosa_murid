...
<body>
    <section class="w-screen h-screen relative">
        <img src="{{asset('img/kratos.jpg')}}" class="w-screen h-screen object-cover">
        <div class="absolute top-0 left-0 w-screen h-screen bg-black bg-opacity-40 text-center">
            <div class="container mx-auto px-4 h-full flex flex-col justify-center items-center">
                ...
                <form action="{{route('profill')}}" class="w-full">
                    <div class="flex flex-wrap justify-center">
                        ...
                        <button type="submit"
                            class="px-5 py-3 mb-3 text-xl font-medium text-center text-white bg-red-800 rounded-lg hover:bg-red-950 focus:ring-4 focus:outline-none focus:ring-blue-300">Cari</button>
                    </div>
                </form>
            </div>
        </div>
